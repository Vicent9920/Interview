...
public class Kawaii_LoadingView extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setColor(getResources().getColor(R.color.colorPrimaryText));
        ...
        int baseLineY = (int) ((mfixedBlocks[1].rectF.centerY()-96) - top/2 - bottom/2);//基线中间点的y轴计算公式

        canvas.drawText("马上加载完成",(mfixedBlocks[1].rectF.centerX()),baseLineY,textPaint);
